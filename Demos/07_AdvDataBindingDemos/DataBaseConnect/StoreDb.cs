...
namespace StoreDatabase
{
	public class StoreDb
	{
        ...
        {
            //connectionString = @"Data Source=(localdb)\v11.0; Initial Catalog = Store;Integrated Security = true;";
            //connectionString = @"Data Source = (localdb)\ProjectsV12; Initial Catalog = Store; Integrated Security = True;
            //connectionString = @"Data Source = (localdb)\ProjectsV12; Initial Catalog = Store; Integrated Security = True; Connect Timeout = 30; Encrypt = False; TrustServerCertificate = False; ApplicationIntent = ReadWrite; MultiSubnetFailover = False;";
